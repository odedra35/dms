...
config = load_config()
app.config.update(config['domains'])
timeout = config['domains']['response_timeout']
url_limit_per_user=config['domains']['limit_per_user']
...
def check_ssl_and_status_bulk(urls, url_limit_per_user) -> list:
